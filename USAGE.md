...
This will:
- ✅ Auto-detect your project type (React, .NET, Node.js, etc.)
- ✅ Create test directory structure
- ✅ Generate Playwright configuration
- ✅ Set up MCP server connection
- ✅ Configure your IDE (Cursor, VS Code, JetBrains, etc.)
...
- User journey: User registration → Login → Create product → View products
